      ...
      <div className="p-14 grid md:grid-cols-2 gap-5">
        <div className="rounded-lg border-4 border-gray-100 bg-white p-4 shadow-sm transition hover:shadow-lg sm:p-6">
          <div className="text-lg my-4 font-semibold">
            <label className="bg-purple-600 pl-3 pr-3 p-2 rounded-full text-white">
              Step - 1
            </label>
          </div>
          <div className="md:p-1 lg:p-1 sm:p-0">
            ...
            <p className="mt-2 line-clamp-3 text-sm/relaxed text-gray-500 md:text-justify sm:text-center">
              Start by signing up for VirtuView and creating your profile in
              just a few clicks. Fill in your details like  role, the tech stack you are applying for and years of experience (if any)
               to get the most accurate mock interview experiences.
              Your information helps us tailor the questions and feedback to
              match your career needs.
            </p>

            <a
              href="#"
              className="group mt-4 inline-flex items-center gap-1 text-sm font-medium text-purple-600"
            >
              Find out more
              <span
                aria-hidden="true"
        ...
        <div className="rounded-lg border-4 border-gray-100 bg-white p-4 shadow-sm transition hover:shadow-lg sm:p-6">
          ...
          <div className="md:p-1 lg:p-1 sm:p-0">
            ...
            <p className="mt-2 line-clamp-3 text-sm/relaxed text-gray-500 text-justify">
              ...
              a software engineering role or a marketing position, VirtuView
              provides customized mock interview scenarios to fit your needs.
            </p>
        ...
        <div className="rounded-lg border-4 border-gray-100 bg-white p-4 shadow-sm transition hover:shadow-lg sm:p-6">
          ...
          <div className="md:p-1 lg:p-1 sm:p-0">
            <a href="#">
              <h3 className="mt-0.5 text-lg font-semibold text-purple-700">
        ...
        <div className="rounded-lg border-4 border-gray-100 bg-white p-4 shadow-sm transition hover:shadow-lg sm:p-6">
          ...
          <div className="md:p-1 lg:p-1 sm:p-0">
            ...
            <p className="mt-2 line-clamp-3 text-sm/relaxed text-gray-500 text-justify">
              ...
              insights on your strengths and areas for improvement. VirtuView
              provides in-depth suggestions and tips to enhance your answers,
              helping you get interview-ready. Use this feedback to continuously
              improve and ace real interviews.
            </p>
